...
RSpec.describe Sinatra::Application do
  ...
  describe 'GET /quotes' do
    ...
    context 'when there are quotes' do
      let!(:q) { Quote.create(text: quote, author: author, source: source, approved: false) }
  ...
  describe 'POST /quotes' do
    let!(:valid_params) { { text: quote, author: author, source: source } }

    %i[text author source].each do |attr|
